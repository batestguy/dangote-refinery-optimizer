...
- **Next up (Phase 2 remainder):** cost anchor — EIA `EPCBRENT` + documented Bonny differential (row 9) to replace placeholder costs; quality-spec LBIs (RON/cetane/RVP constraints, spec §3.3) into the penalty block; then Stage-2 ETR (Phase 3).
