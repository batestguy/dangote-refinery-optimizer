...
- **Next up:** ④ finalize 5-crude slate from vendor assays (spec §8 item 1) — parse into `AssayRecord`s; Electric Sheep cost anchor stays labeled-synthetic; then Phase 1 exit.
