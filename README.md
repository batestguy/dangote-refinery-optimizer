...
| Assay→yield bridge (TBP cut-points + published FCC correlations) | 🔜 Phase 2 |
| ETR surrogate, dual-CV validation (random + leave-crude-out) | 🔜 Phase 3 |
| App (marimo, deploys to HF Spaces) | ✅ POC with placeholder yield model |
| Prices | placeholder constants → EIA-anchored in Phase 1 |
